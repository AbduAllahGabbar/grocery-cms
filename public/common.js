...
/***/ "./src/app/orders/orders.model.ts":
/*!****************************************!*\
  !*** ./src/app/orders/orders.model.ts ***!
  \****************************************/
/*! exports provided: OrderFromEnum, PaymentTypeEnum, OrderTypesEnum */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrderFromEnum", function() { return OrderFromEnum; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PaymentTypeEnum", function() { return PaymentTypeEnum; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrderTypesEnum", function() { return OrderTypesEnum; });
var OrderFromEnum;
(function (OrderFromEnum) {
    OrderFromEnum["POS"] = "POS";
    OrderFromEnum["MOBILE"] = "USER_APP";
    OrderFromEnum["WEBSITE"] = "WEB_APP";
})(OrderFromEnum || (OrderFromEnum = {}));
var PaymentTypeEnum;
...
(function (OrderTypesEnum) {
    OrderTypesEnum["PURCHASES"] = "PURCHASES";
    OrderTypesEnum["SUBSCRIPTIONS"] = "SUBSCRIPTIONS";
...
/***/ "./src/app/pos/pos.model.ts":
/*!**********************************!*\
  !*** ./src/app/pos/pos.model.ts ***!
  \**********************************/
/*! exports provided: OrderType, ChangeQuantityEnum */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrderType", function() { return OrderType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChangeQuantityEnum", function() { return ChangeQuantityEnum; });
var OrderType;
(function (OrderType) {
    OrderType["DELIVERY"] = "DELIVERY";
    OrderType["PICK_UP"] = "PICK_UP";
})(OrderType || (OrderType = {}));
var ChangeQuantityEnum;
(function (ChangeQuantityEnum) {
    ChangeQuantityEnum["INCREMENT"] = "INCREMENT";
    ChangeQuantityEnum["DECREMENT"] = "DECREMENT";
})(ChangeQuantityEnum || (ChangeQuantityEnum = {}));
