...
var SocketSharedService = /** @class */ (function () {
    ...
    SocketSharedService.prototype.listenToOrderStatusUpdateNotifications = function () {
        ...
        this.socket.on('order-status-update', function (notificationData) {
            ...
            if (notificationData.notifyType == NotificationType.ORDER_PLACED) {
                _this.playOrderNotificationAudio();
            }
    ...
    // plays audio when a new order is placed
    SocketSharedService.prototype.playOrderNotificationAudio = function () {
...
function getLanguageList(http, translateService) {
    return function () {
        return http
            .get(_environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].API_ENDPOINT + "/languages/list")
            .toPromise()
            .then(function (data) {
...
var OrderService = /** @class */ (function () {
    ...
    // Get all order
    OrderService.prototype.getAll = function (page, limit, status, id, type) {
    ...
    // Gets all POS order
    OrderService.prototype.getAllPOSOrders = function (page, limit, status, id) {
...
var ProductService = /** @class */ (function () {
    ...
    // gets product information for POS purpose
    ProductService.prototype.getPOSProductInfo = function (categoryId, page, limit) {
        return this.crud.getData("/products/admin/pos-category/" + categoryId + "?limit=" + limit + "&page=" + page);
    };
    ...
    // gets product search information for POS purpose
    ProductService.prototype.getPOSProductInfoBySearch = function (search, page, limit) {
        return this.crud.getData("/products/admin/search?limit=" + limit + "&page=" + page + "&q=" + search);
    };
...
var SettingService = /** @class */ (function () {
    ...
    // gets time slots dropdown list 
    SettingService.prototype.getTimeSlotDropdownList = function () {
        return this.crud.getData('/settings/admin/time-slots-dropdown');
    };
    ...
    SettingService.prototype.getWorkingHourSlots = function () {
...
var CustomLoaderComponent = /** @class */ (function () {
    ...
    CustomLoaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CustomLoaderComponent, selectors: [["app-custom-loader"]], decls: 2, vars: 0, consts: [[1, "custom-loader"], [1, "loader"]], template: function CustomLoaderComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        } }, styles: [".custom-loader[_ngcontent-%COMP%] {\n  margin: 0 auto;\n  background: black;\n  position: absolute;\n  border-radius: 50%;\n  width: 50px;\n  height: 50px;\n  top: 15%;\n  left: 50%;\n  z-index: 1;\n}\n\n.custom-loader[_ngcontent-%COMP%]   .loader[_ngcontent-%COMP%] {\n  border-radius: 50%;\n  width: 35px;\n  height: 35px;\n  border: 3.5px solid #fff;\n  border-color: white transparent white transparent;\n  -webkit-animation: spin 1.4s linear infinite;\n          animation: spin 1.4s linear infinite;\n  \n  \n  \n  position: absolute;\n  \n  \n  top: 15%;\n  left: 15%;\n  transform: translate(-50%, -50%);\n}\n\n@-webkit-keyframes spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  50% {\n    transform: rotate(180deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n\n@keyframes spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  50% {\n    transform: rotate(180deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
var FooterComponent = /** @class */ (function () {
    ...
    FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FooterComponent, selectors: [["app-footer"]], decls: 8, vars: 5, consts: [[1, "container-fluid", "p-0"], [1, "copyright", "text-center", "m-0"]], template: function FooterComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        } }, pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"]], styles: [".copyright[_ngcontent-%COMP%] {\n  background-color: #000;\n  padding: 15px;\n  color: #fff;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
function NavbarComponent_option_18_Template(rf, ctx) { if (rf & 1) {
    ...
    var lang_r126 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("value", lang_r126.languageCode);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](lang_r126.languageName);
} }
function NavbarComponent_span_22_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](ctx_r124.unreadTotal);
} }
function NavbarComponent_a_28_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NavbarComponent_a_28_Template_a_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r130); var order_r127 = ctx.$implicit; var ctx_r129 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r129.viewOrder(order_r127); });
    ...
    var order_r127 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"]("", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](5, 3, "ORDER_ID"), " :", order_r127.orderID, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](order_r127.title);
} }
...
var NotificationSidebarComponent = /** @class */ (function () {
    ...
    NotificationSidebarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NotificationSidebarComponent, selectors: [["app-notification-sidebar"]], viewQuery: function NotificationSidebarComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, decls: 0, vars: 0, template: function NotificationSidebarComponent_Template(rf, ctx) { }, styles: ["#notification-sidebar[_ngcontent-%COMP%] {\n  width: 400px;\n  right: -400px;\n  padding: 0;\n  background-color: #FFF;\n  z-index: 1051;\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  height: 100vh;\n  transition: right 0.4s cubic-bezier(0.05, 0.74, 0.2, 0.99);\n  -webkit-backface-visibility: hidden;\n          backface-visibility: hidden;\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n  box-shadow: 0 0 8px rgba(0, 0, 0, 0.1);\n}\n\n#notification-sidebar.open[_ngcontent-%COMP%] {\n  right: 0;\n}\n\n#notification-sidebar[_ngcontent-%COMP%]   .notification-sidebar-content[_ngcontent-%COMP%] {\n  position: relative;\n  height: 100%;\n  padding: 10px;\n}\n\n#notification-sidebar[_ngcontent-%COMP%]   .notification-sidebar-content[_ngcontent-%COMP%]   #timeline.timeline-left[_ngcontent-%COMP%]   .timeline-item[_ngcontent-%COMP%]:before {\n  border: none;\n}\n\n#notification-sidebar[_ngcontent-%COMP%]   .notification-sidebar-content[_ngcontent-%COMP%]   #timeline.timeline-left[_ngcontent-%COMP%]   .timeline-item[_ngcontent-%COMP%]:after {\n  border: none;\n}\n\n#notification-sidebar[_ngcontent-%COMP%]   .notification-sidebar-content[_ngcontent-%COMP%]   #settings[_ngcontent-%COMP%]   .switch[_ngcontent-%COMP%] {\n  border: none;\n}\n\n#notification-sidebar[_ngcontent-%COMP%]   a.notification-sidebar-toggle[_ngcontent-%COMP%] {\n  background: #FFF;\n  color: theme-color(\"primary\");\n  display: block;\n  box-shadow: -3px 0px 8px rgba(0, 0, 0, 0.1);\n}\n\n#notification-sidebar[_ngcontent-%COMP%]   a.notification-sidebar-close[_ngcontent-%COMP%] {\n  color: #000;\n}\n\n#notification-sidebar[_ngcontent-%COMP%]   .notification-sidebar-close[_ngcontent-%COMP%] {\n  position: absolute;\n  right: 10px;\n  top: 10px;\n  padding: 7px;\n  width: auto;\n  z-index: 10;\n}\n\n#notification-sidebar[_ngcontent-%COMP%]   .notification-sidebar-toggle[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 35%;\n  width: 54px;\n  height: 50px;\n  left: -54px;\n  text-align: center;\n  line-height: 50px;\n  cursor: pointer;\n}\n\n[dir=\"rtl\"]   [_nghost-%COMP%]     #notification-sidebar {\n  left: -400px;\n  right: auto;\n}\n\n[dir=\"rtl\"]   [_nghost-%COMP%]     #notification-sidebar.open {\n  left: 0;\n  right: auto;\n}\n\n[dir=\"rtl\"]   [_nghost-%COMP%]     #notification-sidebar .notification-sidebar-close {\n  left: 10px;\n  right: auto;\n}\n\n[dir=\"rtl\"]   [_nghost-%COMP%]     #notification-sidebar .notification-sidebar-toggle {\n  right: -54px;\n  left: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
var Full_ROUTES = [
    {
        ...
        loadChildren: function () {
            return Promise.all(/*! import() | settings-settings-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("default~admin-admin-module~banner-banner-module~deals-deals-module~orders-orders-module~pos-pos-modu~799b5683"), __webpack_require__.e("default~dashboard-dashboard-module~orders-orders-module~otp-verify-otp-verify-module~products-produc~bc9fa6ab"), __webpack_require__.e("default~reports-report-module~settings-settings-module"), __webpack_require__.e("default~orders-orders-module~settings-settings-module"), __webpack_require__.e("common"), __webpack_require__.e("settings-settings-module")]).then(__webpack_require__.bind(null, /*! ../../settings/settings.module */ "./src/app/settings/settings.module.ts")).then(function (m) { return m.SettingsModule; });
        },
    ...
    },
    {
        path: "admins",
        loadChildren: function () {
            return Promise.all(/*! import() | admin-admin-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("default~admin-admin-module~banner-banner-module~deals-deals-module~orders-orders-module~pos-pos-modu~799b5683"), __webpack_require__.e("default~admin-admin-module~banner-banner-module"), __webpack_require__.e("admin-admin-module")]).then(__webpack_require__.bind(null, /*! ../../admin/admin.module */ "./src/app/admin/admin.module.ts")).then(function (m) { return m.AdminModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
        path: "products",
        loadChildren: function () {
            return Promise.all(/*! import() | products-products-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("default~admin-admin-module~banner-banner-module~deals-deals-module~orders-orders-module~pos-pos-modu~799b5683"), __webpack_require__.e("default~dashboard-dashboard-module~orders-orders-module~otp-verify-otp-verify-module~products-produc~bc9fa6ab"), __webpack_require__.e("common"), __webpack_require__.e("products-products-module")]).then(__webpack_require__.bind(null, /*! ../../products/products.module */ "./src/app/products/products.module.ts")).then(function (m) { return m.ProductModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
        path: "sub-category",
        loadChildren: function () {
            return Promise.all(/*! import() | sub-category-sub-category-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("default~admin-admin-module~banner-banner-module~deals-deals-module~orders-orders-module~pos-pos-modu~799b5683"), __webpack_require__.e("common"), __webpack_require__.e("sub-category-sub-category-module")]).then(__webpack_require__.bind(null, /*! ../../sub-category/sub-category.module */ "./src/app/sub-category/sub-category.module.ts")).then(function (module) { return module.SubCategoryModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
        path: "out-of-stock",
        loadChildren: function () {
            return Promise.all(/*! import() | out-of-stock-out-of-stock-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("out-of-stock-out-of-stock-module")]).then(__webpack_require__.bind(null, /*! ../../out-of-stock/out-of-stock.module */ "./src/app/out-of-stock/out-of-stock.module.ts")).then(function (module) { return module.OutOfStockModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
    ...
    },
    {
        path: "categories",
        loadChildren: function () {
            return Promise.all(/*! import() | categories-categories-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("common"), __webpack_require__.e("categories-categories-module")]).then(__webpack_require__.bind(null, /*! ../../categories/categories.module */ "./src/app/categories/categories.module.ts")).then(function (m) { return m.CategoriesModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
        path: "sub-category",
        loadChildren: function () {
            return Promise.all(/*! import() | sub-category-sub-category-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("default~admin-admin-module~banner-banner-module~deals-deals-module~orders-orders-module~pos-pos-modu~799b5683"), __webpack_require__.e("common"), __webpack_require__.e("sub-category-sub-category-module")]).then(__webpack_require__.bind(null, /*! ../../sub-category/sub-category.module */ "./src/app/sub-category/sub-category.module.ts")).then(function (m) { return m.SubCategoryModule; });
        },
    },
    {
        path: "banner",
        loadChildren: function () {
            return Promise.all(/*! import() | banner-banner-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~banner-banner-module~deals-deals-module~orders-orders-module~pos-pos-modu~799b5683"), __webpack_require__.e("default~admin-admin-module~banner-banner-module"), __webpack_require__.e("common"), __webpack_require__.e("banner-banner-module")]).then(__webpack_require__.bind(null, /*! ../../banner/banner.module */ "./src/app/banner/banner.module.ts")).then(function (module) { return module.BannerModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
        ...
        loadChildren: function () {
            return Promise.all(/*! import() | notification-list-notification-list-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("notification-list-notification-list-module")]).then(__webpack_require__.bind(null, /*! ../../notification-list/notification-list.module */ "./src/app/notification-list/notification-list.module.ts")).then(function (module) { return module.NotificationListModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
        path: "delivery-boy",
        loadChildren: function () {
            return Promise.all(/*! import() | delivery-boy-delivery-boy-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("common"), __webpack_require__.e("delivery-boy-delivery-boy-module")]).then(__webpack_require__.bind(null, /*! ../../delivery-boy/delivery-boy.module */ "./src/app/delivery-boy/delivery-boy.module.ts")).then(function (m) { return m.DeliveryBoyModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
        path: "deals",
        loadChildren: function () {
            return Promise.all(/*! import() | deals-deals-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("default~admin-admin-module~banner-banner-module~deals-deals-module~orders-orders-module~pos-pos-modu~799b5683"), __webpack_require__.e("common"), __webpack_require__.e("deals-deals-module")]).then(__webpack_require__.bind(null, /*! ../../deals/deals.module */ "./src/app/deals/deals.module.ts")).then(function (m) { return m.DealsModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
    ...
    },
    {
        path: "orders",
        loadChildren: function () {
            return Promise.all(/*! import() | orders-orders-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~banner-banner-module~deals-deals-module~orders-orders-module~pos-pos-modu~799b5683"), __webpack_require__.e("default~dashboard-dashboard-module~orders-orders-module~otp-verify-otp-verify-module~products-produc~bc9fa6ab"), __webpack_require__.e("default~orders-orders-module~settings-settings-module"), __webpack_require__.e("common"), __webpack_require__.e("orders-orders-module")]).then(__webpack_require__.bind(null, /*! ../../orders/orders.module */ "./src/app/orders/orders.module.ts")).then(function (m) { return m.OrdersModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
    ...
    {
        path: "pos",
        loadChildren: function () { return Promise.all(/*! import() | pos-pos-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~banner-banner-module~deals-deals-module~orders-orders-module~pos-pos-modu~799b5683"), __webpack_require__.e("common"), __webpack_require__.e("pos-pos-module")]).then(__webpack_require__.bind(null, /*! ../../pos/pos.module */ "./src/app/pos/pos.module.ts")).then(function (m) { return m.PosModule; }); },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
        path: "users",
        loadChildren: function () {
            return Promise.all(/*! import() | users-users-module */[__webpack_require__.e("default~admin-admin-module~banner-banner-module~categories-categories-module~coupons-coupons-module~~e64928c8"), __webpack_require__.e("default~admin-admin-module~categories-categories-module~coupons-coupons-module~deals-deals-module~de~86b0ae36"), __webpack_require__.e("default~dashboard-dashboard-module~orders-orders-module~otp-verify-otp-verify-module~products-produc~bc9fa6ab"), __webpack_require__.e("common"), __webpack_require__.e("users-users-module")]).then(__webpack_require__.bind(null, /*! ../../users/users.module */ "./src/app/users/users.module.ts")).then(function (m) { return m.UsersModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
    {
    ...
    },
    {
        path: "reports",
        loadChildren: function () {
            return Promise.all(/*! import() | reports-report-module */[__webpack_require__.e("default~reports-report-module~settings-settings-module"), __webpack_require__.e("common"), __webpack_require__.e("reports-report-module")]).then(__webpack_require__.bind(null, /*! ../../reports/report.module */ "./src/app/reports/report.module.ts")).then(function (module) { return module.ReportModule; });
        },
        canActivate: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
    },
];
...
function SidebarComponent_li_16_a_1_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuItem_r135 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](2, _c1, menuItem_r135.badgeClass));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](menuItem_r135.badge);
} }
function SidebarComponent_li_16_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuItem_r135 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("routerLink", menuItem_r135.class === "" ? _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](6, _c1, menuItem_r135.path) : null);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](8, _c1, menuItem_r135.icon));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](4, 4, menuItem_r135.title));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", menuItem_r135.badge != "");
} }
...
function SidebarComponent_li_16_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuItem_r135 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("href", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](6, _c1, menuItem_r135.path), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](8, _c1, menuItem_r135.icon));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](4, 4, menuItem_r135.title));
...
function SidebarComponent_li_16_ul_4_li_1_a_1_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuSubItem_r147 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](2, _c1, menuSubItem_r147.badgeClass));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](menuSubItem_r147.badge);
} }
function SidebarComponent_li_16_ul_4_li_1_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuSubItem_r147 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("routerLink", menuSubItem_r147.submenu.length > 0 ? null : _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](6, _c1, menuSubItem_r147.path));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](8, _c1, menuSubItem_r147.icon));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](4, 4, menuSubItem_r147.title));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", menuSubItem_r147.badge != "");
} }
...
function SidebarComponent_li_16_ul_4_li_1_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuSubItem_r147 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("href", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](6, _c1, menuSubItem_r147.path), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](8, _c1, menuSubItem_r147.icon));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](4, 4, menuSubItem_r147.title));
...
function SidebarComponent_li_16_ul_4_li_1_ul_4_li_1_a_1_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuSubsubItem_r159 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](2, _c1, menuSubsubItem_r159.badgeClass));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](menuSubsubItem_r159.badge);
} }
function SidebarComponent_li_16_ul_4_li_1_ul_4_li_1_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuSubsubItem_r159 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("routerLink", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](6, _c1, menuSubsubItem_r159.path));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](8, _c1, menuSubsubItem_r159.icon));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](4, 4, menuSubsubItem_r159.title));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", menuSubsubItem_r159.badge != "");
} }
...
function SidebarComponent_li_16_ul_4_li_1_ul_4_li_1_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuSubsubItem_r159 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("href", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](6, _c1, menuSubsubItem_r159.path), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](8, _c1, menuSubsubItem_r159.icon));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](4, 4, menuSubsubItem_r159.title));
...
function SidebarComponent_li_16_ul_4_li_1_ul_4_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuSubsubItem_r159 = ctx.$implicit;
    var _r161 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](3);
    var menuSubItem_r147 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    var ctx_r158 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("level", ctx_r158.depth + 3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("routePath", menuSubsubItem_r159.path)("classes", menuSubsubItem_r159.class)("title", menuSubsubItem_r159.title)("parent", menuSubItem_r147.title)("routerLinkActiveOptions", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction0"](9, _c2))("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](10, _c1, menuSubsubItem_r159.class));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", !menuSubsubItem_r159.isExternalLink)("ngIfElse", _r161);
} }
function SidebarComponent_li_16_ul_4_li_1_ul_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("@slideInOut", ctx_r151.activeTitles.includes(menuSubItem_r147.title) ? true : false);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", menuSubItem_r147.submenu);
} }
...
function SidebarComponent_li_16_ul_4_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuSubItem_r147 = ctx.$implicit;
    var _r149 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](3);
    var menuItem_r135 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    var ctx_r146 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("level", ctx_r146.depth + 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("routePath", menuSubItem_r147.path)("classes", menuSubItem_r147.class)("title", menuSubItem_r147.title)("parent", menuItem_r135.title)("routerLinkActive", menuSubItem_r147.submenu.length > 0 ? "" : "active")("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction3"](10, _c3, menuSubItem_r147.class === "has-sub" ? true : false, ctx_r146.activeTitles.includes(menuSubItem_r147.title) && !ctx_r146.nav_collapsed_open ? true : false, ctx_r146.nav_collapsed_open && ctx_r146.activeTitles.includes(menuSubItem_r147.title)));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", !menuSubItem_r147.isExternalLink)("ngIfElse", _r149);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", menuSubItem_r147.submenu.length > 0);
} }
function SidebarComponent_li_16_ul_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("@slideInOut", ctx_r139.activeTitles.includes(menuItem_r135.title) ? true : false);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", menuItem_r135.submenu);
} }
function SidebarComponent_li_16_Template(rf, ctx) { if (rf & 1) {
    ...
    var menuItem_r135 = ctx.$implicit;
    var _r137 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](3);
    var ctx_r134 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("level", ctx_r134.depth + 1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("routePath", menuItem_r135.path)("classes", menuItem_r135.class)("title", menuItem_r135.title)("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction3"](10, _c3, menuItem_r135.class === "has-sub" ? true : false, ctx_r134.activeTitles.includes(menuItem_r135.title) && !ctx_r134.nav_collapsed_open ? true : false, ctx_r134.nav_collapsed_open && ctx_r134.activeTitles.includes(menuItem_r135.title)))("routerLinkActive", menuItem_r135.submenu.length != 0 ? "" : "active")("routerLinkActiveOptions", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction0"](14, _c2));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", !menuItem_r135.isExternalLink)("ngIfElse", _r137);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", menuItem_r135.submenu.length > 0);
} }
...
var UtilService = /** @class */ (function () {
    ...
    UtilService.prototype.showToast = function (messageField, titleField, type, isApiRes) {
        this.toastrService.show(!isApiRes ? this.languageJSON[messageField] : messageField, '', { timeOut: 5000 }, type);
    };
    UtilService.prototype.successMessage = function (message, isLocal) {
        var msg = isLocal ? this.languageJSON[message] : message;
        this.toastrService.show(msg, '', { timeOut: 5000 }, ToastEnum.SUCCESS);
    };
    UtilService.prototype.errorMessage = function (message, isLocal, extra) {
        var msg = isLocal ? "" + this.languageJSON[message] + (extra ? ' ' + extra : '') : message;
        this.toastrService.show(msg, '', { timeOut: 5000 }, ToastEnum.ERROR);
    };
    UtilService.prototype.infoMessage = function (message, isLocal) {
        var msg = isLocal ? this.languageJSON[message] : message;
        this.toastrService.show(msg, '', { timeOut: 5000 }, ToastEnum.INFO);
    };
    UtilService.prototype.warningMessage = function (message, isLocal) {
        var msg = isLocal ? this.languageJSON[message] : message;
        this.toastrService.show(msg, '', { timeOut: 5000 }, ToastEnum.WARNING);
    };
    // get's translated messagep
    UtilService.prototype.getTranslatedMessage = function (translationKey) {
        return this.languageJSON[translationKey];
    };
    // public infoMessage(key: string): void {
    // 	this.toastrService.show(this.languageJSON[key], 'INFO', { timeOut: 5000 }, ToastEnum.INFO);
    // }
...
module.exports = __webpack_require__(/*! E:\grocery2021\grocery-cms\src\main.ts */"./src/main.ts");
