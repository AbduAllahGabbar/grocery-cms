...
export class UtilService {
	...
	public errorMessage(message: string, isLocal?: boolean, extra?: any): void {
		const msg = isLocal ? `${this.languageJSON[message]}${extra ? ' ' + extra : ''}` : message;
	...
	public getTranslatedMessage(translationKey: string): string {
