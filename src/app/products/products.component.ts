...
export class ProductComponent implements OnInit {
	...
	public getAllProductBySearch() {
		this.productService.getPOSProductInfoBySearch(this.search, this.page, this.limit).subscribe((res: any) => {
			this.products = (res != null) && (res.response_code === 200) ? res.response_data : [];
