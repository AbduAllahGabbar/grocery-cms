...
export class ProductService {
	...
	public getPOSProductInfo(categoryId: string, page: number, limit: number): Observable<any> {
	...
	public getPOSProductInfoBySearch(search: string, page: number, limit: number): Observable<any> {
